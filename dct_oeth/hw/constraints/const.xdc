...
#set_multicycle_path 2 -setup -from [get_clocks eth_clk] -to [get_clocks ETH_REFCLK]
create_generated_clock -name eth_clk [get_pins {eth_rst_gen_i/gen_50M/inst/mmcm_adv_inst/CLKOUT0}]
create_generated_clock -name ETH_REFCLK [get_pins {eth_rst_gen_i/gen_50M/inst/mmcm_adv_inst/CLKOUT1}]
set_output_delay -clock ETH_REFCLK 2.5 [get_ports ETH_TXEN]
set_output_delay -clock ETH_REFCLK 2.5 [get_ports {ETH_TXD[*]}]
